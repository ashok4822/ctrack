...
export default function OperatorTransitTracking() {
    ...
    // Filter gate-out and in-transit containers from dummyContainers if needed, 
    // but we'll use dummyTransitContainers for the summary list as it has origin/destination info
        ...
        >
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle>Dispatched Containers</CardTitle>
                        ...
                        <div className="space-y-6">
                          ...
                          ${checkpoint.status === 'completed'
                                    ...
                                    <div className="pl-10 py-8 text-center text-muted-foreground">
                                        ...
                                        <p className="text-sm">Tracking will begin once the container is gated out.</p>
                                    </div>
                                )}
                            </div>
                        </div>
